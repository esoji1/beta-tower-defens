...
public class PointByPoint
{
    ...
    private Assets.Scripts.EmenyWaveSpawner.IMovable _movable;
    ...
    public PointByPoint(Assets.Scripts.EmenyWaveSpawner.IMovable movable, IEnumerable<Vector3> targets)
    {
        _movable = movable;
